// src/components/VenueSidebar.js
...
export default function VenueSidebar({
  ...
  startTime,
  endTime,
  // Logic Functions (Passed from parent)
        ...
        <div className="mt-2">
          ...
          <div className="grid grid-cols-7 gap-2">
            {calendarCells.map((cell, idx) => {
              ...
              // Use passed function for status
              const status = getCalendarDayStatus
                ? getCalendarDayStatus(key, selectedHall)
                : "free";
              ...
              if (status === "none") {
                ...
                badgeText = "—";
                badgeDot = isDtao ? "bg-slate-500" : "bg-slate-400";
              }
              ...
              return (
                <button
                  key={idx}
                  type="button"
                  onClick={() => handleCalendarDayClick && handleCalendarDayClick(cell)}
                ...
                >
                  <span
                    className={`${
                      isDtao ? "text-slate-900" : "text-slate-900"
                  ...
                  <div className="flex items-center gap-1 text-[11px] mt-auto">
                    ...
                    <span
                      className={`${
                        isDtao ? "text-slate-800" : "text-slate-700"
                      }`}
                    >
                      {badgeText}
                    </span>
